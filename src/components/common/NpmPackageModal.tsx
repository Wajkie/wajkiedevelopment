          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                aria-label={tr.packages.closeModal}
              >
                ×
              </button>
            </div>
            ...
            {info.keywords && info.keywords.length > 0 && (
              <div>
                <h3 className="font-semibold text-lg mb-3">{tr.packages.keywords}</h3>
            ...
            {/* Maintainers */}
            <div>
              <h3 className="font-semibold text-lg mb-3">{tr.packages.maintainers}</h3>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-gray-600 dark:text-gray-400">{tr.packages.published}</span>
                <div className="font-medium">{packageDate}</div>
              </div>
              <div>
                <span className="text-gray-600 dark:text-gray-400">{tr.packages.lastUpdated}</span>
