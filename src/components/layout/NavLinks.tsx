...
export default function NavLinks({ githubOwner, npmUsername }: Props) {
  ...
  const navLinks = [
    ...
    { href: '/journey', label: tr.nav.journey },
    { href: '/projects', label: tr.nav.projects },
    { href: '/packages', label: tr.nav.packages },
    { href: '/blog', label: tr.nav.blog },
    { href: '/project-info', label: tr.nav.tech },
    { href: '/admin/analytics', label: tr.nav.analytics },
  ];
    ...
    <>
      <Button asChild variant="ghost" size="sm">
        <a
          ...
          aria-label={tr.nav.githubAriaLabel}
        >
      ...
      <Button asChild variant="ghost" size="sm">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label={tr.nav.npmAriaLabel}
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <>
      {/* Desktop nav */}
      <div className="hidden md:flex items-center gap-2" role="navigation" aria-label={tr.nav.sideLabel}>
